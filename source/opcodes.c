...
const static uacpi_u8 ext_op_to_idx[0x100] = {
    ...
    [_(UACPI_AML_OP_DebugOp)]      = 17, [_(UACPI_AML_OP_TimerOp)]       = 18,
    [_(UACPI_AML_OP_OpRegionOp)]   = 19, [_(UACPI_AML_OP_FieldOp)]       = 20,
    [_(UACPI_AML_OP_DeviceOp)]     = 21, [_(UACPI_AML_OP_ProcessorOp)]   = 22,
    [_(UACPI_AML_OP_PowerResOp)]   = 23, [_(UACPI_AML_OP_ThermalZoneOp)] = 24,
    [_(UACPI_AML_OP_IndexFieldOp)] = 25, [_(UACPI_AML_OP_BankFieldOp)]   = 26,
    [_(UACPI_AML_OP_DataRegionOp)] = 27,
};
