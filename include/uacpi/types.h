...
#define UACPI_OBJECT_INTEGER_BIT (UACPI_OBJECT_INTEGER << 1)
#define UACPI_OBJECT_STRING_BIT (UACPI_OBJECT_STRING << 1)
#define UACPI_OBJECT_BUFFER_BIT (UACPI_OBJECT_BUFFER << 1)
#define UACPI_OBJECT_PACKAGE_BIT (UACPI_OBJECT_PACKAGE << 1)
#define UACPI_OBJECT_UNIT_FIELD_BIT (UACPI_OBJECT_UNIT_FIELD << 1)
#define UACPI_OBJECT_DEVICE_BIT (UACPI_OBJECT_DEVICE << 1)
#define UACPI_OBJECT_EVENT_BIT (UACPI_OBJECT_EVENT << 1)
#define UACPI_OBJECT_METHOD_BIT (UACPI_OBJECT_METHOD << 1)
#define UACPI_OBJECT_MUTEX_BIT (UACPI_OBJECT_MUTEX << 1)
#define UACPI_OBJECT_OPERATION_REGION_BIT (UACPI_OBJECT_OPERATION_REGION << 1)
#define UACPI_OBJECT_POWER_RESOURCE_BIT (UACPI_OBJECT_POWER_RESOURCE << 1)
#define UACPI_OBJECT_PROCESSOR_BIT (UACPI_OBJECT_PROCESSOR << 1)
#define UACPI_OBJECT_THERMAL_ZONE_BIT (UACPI_OBJECT_THERMAL_ZONE << 1)
#define UACPI_OBJECT_BUFFER_FIELD_BIT (UACPI_OBJECT_BUFFER_FIELD << 1)
#define UACPI_OBJECT_DEBUG_BIT (UACPI_OBJECT_DEBUG << 1)
#define UACPI_OBJECT_REFERENCE_BIT (UACPI_OBJECT_REFERENCE << 1)
#define UACPI_OBJECT_BUFFER_INDEX_BIT (UACPI_OBJECT_BUFFER_INDEX << 1)
